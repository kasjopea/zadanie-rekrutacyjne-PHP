<?php
if (!(($jsonUsers = file_get_contents('http://jsonplaceholder.typicode.com/users'))&&($jsonAlbums = file_get_contents('http://jsonplaceholder.typicode.com/albums'))&&($jsonPhotos = file_get_contents('http://jsonplaceholder.typicode.com/photos')))) {
      echo "Nie udało się pobrać danych z serwera.";
} else {
...
if (!(isset($fileContain))) {
  ...
  $JSONfileContain = json_encode($fileContain, JSON_UNESCAPED_UNICODE);
} else {
      ...
      <div class="center">
        ...
        <div class="inline">
          <a
            ...
            href="https://twitter.com/typicode"
...
$.ajax({
  ...
  console.log(data);
    ...
    <!--
    <a href="https://github.com/typicode/husky" class="more">
      <p>
